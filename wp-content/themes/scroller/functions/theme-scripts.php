...
function themnific_add_javascript() {
		...
		wp_enqueue_script('purl', get_template_directory_uri().'/js/purl.js','','', true);
		...
		wp_enqueue_script('detecSection', get_template_directory_uri().'/js/detectSection.js','','', true);
		wp_enqueue_script('setURLBackButton', get_template_directory_uri().'/js/setURLBackButton.js','','', true);
	}
?>